          ...
          <div id='recipe_read' className='my-8'>
            <div className='max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2'>
              <img
                ...
                alt='recipe image'
                className='max-w-unset! w-screen md:w-full md:rounded-r-lg mx--10 h-full max-h-[50vh] md:max-h-unset object-cover'
                id='recipe_image'
              />
              <div className='flex justify-center flex-col items-start'>
                <div className='flex justify-start items-center gap-4 mt-4 lg:mt-0'>
                  ...
                  <div onClick={onFollow}>
                    ...
                    <button
                      disabled={apiLoading}
                      className={'font-bold text-center rounded-full block w-full border-0 py-2 disabled:opacity-50 ' +
                        (following
            ...
            <div className='block'>
              <div className='relative'>
                {errorUnpaid
                  ? (
                    <div className='absolute top-0 left-0 bg-gradient-to-b from-white/30 to-white w-full h-full'>
                    </div>
                  )
                  : null}
              </div>
